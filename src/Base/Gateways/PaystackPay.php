...
namespace Venost\LaravelPaymentgateway\Base\Gateways;

use Venost\LaravelPaymentgateway\Base\PaymentGatewayBase;
...
class PaystackPay extends PaymentGatewayBase
{
    ...
    public function charge_customer(array $args)
    {
        ...
        $paystack_data['route'] = route('gts.payment.gateway.paystack');

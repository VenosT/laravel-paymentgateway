...
namespace Venost\LaravelPaymentgateway\Providers;
...
class PaymentgatewayServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //     $this->commands([
        //         \Venost\LaravelPaymentgateway\Console\Commands\PaymentgatewayCommand::class,
        //     ]);
        // }
    ...
    public function register()
    {
         ...
         *
         * */
        app()->bind('LaravelPaymentGateway',function (){
